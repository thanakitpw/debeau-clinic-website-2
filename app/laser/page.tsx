...
const laserPrograms = [
  ...
  },
  {
    ...
    titleTh: "เลเซอร์ฝ้า กระ หน้าใส กระตุ้นคอลลาเจน",
    description:
      "เลเซอร์ความงามตัวแรกของโลกที่ใช้เทคโนโลยี Pico Second ส่งพลังงานความถี่สูงถึง 1 ต่อ ล้านล้านวินาที ทำให้เกิดผลกระทบเชิงกลภาพ (Photomechanical) แทนความร้อน ลดความเสียหายต่อเนื้อเยื่อรอบข้าง ช่วยลดฝ้า กระ จุดด่างดำ รอยดำจากสิว ฟื้นฟูหลุมสิว กระชับรูขุมขน และลบรอยสัก เจ็บน้อยกว่าเลเซอร์แบบดั้งเดิม ลดโอกาสเกิดรอยดำหลังทำ • โปรแกรมรักษาฝ้ากระ 15,000 บ./ครั้ง • โปรแกรมหน้าใส กระตุ้นคอลลาเจน 10,000 บ./ครั้ง",
    tech: "PicoSecond Technology — FDA Approved",
    accent: "#c38789",
  },
];
