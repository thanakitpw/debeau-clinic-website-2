...
const services: {
  ...
  },
  {
    ...
    title: "SKIN BOOSTER",
    titleTh: "งานผิว",
    description: "บำรุงผิวด้วย HA PN PDRN พร้อม Cocktail Set ผิวอินฟลู ด้วย PLLA และ HACA",
  ...
  },
  {
    ...
    title: "IV DRIP",
    titleTh: "Drip ผิว",
    description: "Premium Aura Bright ผิวขาวกระจ่างใส, Immune Booster, Ultimate Skin",
  ...
  },
  {
    ...
    description: "ผลักวิตามินผิวล้ำลึก นวดกระชับใบหน้า มาสก์หน้า คืนความชุ่มชื้นกับผิว",
    icon: <Gem size={20} />,
